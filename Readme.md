...
[For installation instructions / the mod database, see the project site.](https://bl-sdk.github.io/oak2-mod-db/)
...
1. Initialize the git submodules.
   ...
   ```sh
   git clone --recursive https://github.com/bl-sdk/oak2-mod-manager.git
   ```
...
3. (OPTIONAL) If you need to debug your module, and you own the game on Steam, add a
